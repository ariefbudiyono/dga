<!--Action Button-->
@if( Active::checkUriPattern( 'admin/warehouses' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.warehouses.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.warehouses.all' ) }}
            </a>
        </li>
        @permission( 'create-warehouse' )
            <li>
                <a href="{{ route( 'admin.warehouses.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.warehouses.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
