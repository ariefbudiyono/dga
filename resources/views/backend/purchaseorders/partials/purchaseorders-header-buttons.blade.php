<!--Action Button-->
@if( Active::checkUriPattern( 'admin/purchaseorders' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.purchaseorders.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.purchaseorders.all' ) }}
            </a>
        </li>
        @permission( 'create-purchaseorder' )
            <li>
                <a href="{{ route( 'admin.purchaseorders.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.purchaseorders.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
