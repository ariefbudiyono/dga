<!--Action Button-->
@if( Active::checkUriPattern( 'admin/customerorders' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.customerorders.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.customerorders.all' ) }}
            </a>
        </li>
        @permission( 'create-customerorder' )
            <li>
                <a href="{{ route( 'admin.customerorders.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.customerorders.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
