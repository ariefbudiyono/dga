<!--Action Button-->
@if( Active::checkUriPattern( 'admin/factories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.factories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.factories.all' ) }}
            </a>
        </li>
        @permission( 'create-factory' )
            <li>
                <a href="{{ route( 'admin.factories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.factories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
