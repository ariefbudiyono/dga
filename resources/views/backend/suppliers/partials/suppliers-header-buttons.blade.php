<!--Action Button-->
@if( Active::checkUriPattern( 'admin/suppliers' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.suppliers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.suppliers.all' ) }}
            </a>
        </li>
        @permission( 'create-supplier' )
            <li>
                <a href="{{ route( 'admin.suppliers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.suppliers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
