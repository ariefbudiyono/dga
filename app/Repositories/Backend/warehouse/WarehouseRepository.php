...
namespace App\Repositories\Backend\warehouse;
...
class WarehouseRepository extends BaseRepository
{
    ...
    public function getForDataTable()
    {
        return $this->query()
            ->select([
                config('module.warehouses.table').'.id',
                config('module.warehouses.table').'.created_at',
                config('module.warehouses.table').'.updated_at',
            ]);
    }
